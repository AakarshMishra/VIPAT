                ...
                <div className="row">                    
                    <div className="col-sm-6 mx-auto">
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label"><b>Proctor Name</b></label>
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label"><b>Address</b></label>
                            <div className="col-sm-8">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label"><b>Department</b></label>
                            <div className="col-sm-8">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label"><b>Email Id</b></label>
                            <div className="col-sm-8">
