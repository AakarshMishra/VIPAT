                ...
                <div className="row">                    
                    <div className="col-sm-6 mx-auto">
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>Designation</label>
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-4" style={mycomponent4}>Description</label>
                            <div className="col-sm-8">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>Experience</label>
                            <div className="col-sm-8">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>No of Seats</label>
                            <div className="col-sm-8">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>Salary Package</label>
                            <div className="col-sm-8">
