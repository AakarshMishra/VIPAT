    ...
    return(
        ...
        <div className="container-fluid" style={mycomponent}>
            ...
            <h4 className="text-center p-2" style={mycomponent4}>
                Edit Proctor Details
            </h4>
            <form onSubmit={handleSubmit}>
                <div className="row">                    
                    <div className="col-sm-6 mx-auto">
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>Proctor Name</label>
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label p-2" style={mycomponent4}>Department</label>
                            <div className="col-sm-8">
